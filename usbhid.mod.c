...
__used __section("__versions") = {
	...
	{ 0x6bff659, "hid_lookup_quirk" },
	{ 0xa06775b5, "usb_alloc_urb" },
	{ 0x628a8088, "device_set_wakeup_enable" },
	{ 0x9bcada4a, "usb_autopm_put_interface" },
	...
	{ 0x423e0dd7, "hid_check_keys_pressed" },
	...
	{ 0x838a01ec, "usb_autopm_get_interface" },
